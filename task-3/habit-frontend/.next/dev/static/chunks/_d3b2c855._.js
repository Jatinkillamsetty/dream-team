...
function LoginPage() {
    ...
    const handleSubmit = async (e_0)=>{
        ...
        try {
            setLoading(true);
            if (login) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].login(data.email, data.password);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].register(data.email, data.password, data.name);
            }
...
_s(LoginPage, "ai8fdb4m2SC88KQclLnvBmn8NZw=", false, function() {
    return [
...
//# sourceMappingURL=_d3b2c855._.js.map