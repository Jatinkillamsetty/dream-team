...
function LoginPage() {
    ...
    if ($[0] !== "a0691dbbeec1f33aa8a72efbca10c685aca1d2bb81475242da211c4ad87fd19a") {
        for(let $i = 0; $i < 50; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a0691dbbeec1f33aa8a72efbca10c685aca1d2bb81475242da211c4ad87fd19a";
    }
    ...
    if ($[3] !== data || $[4] !== errors) {
        t2 = ({
            "LoginPage[handleChange]": (field)=>(e)=>{
                    setdata({
                        ...data,
    ...
    let t3;
    if ($[6] !== data.email || $[7] !== data.name || $[8] !== data.password || $[9] !== login) {
        t3 = ({
    ...
    const validateform = t3;
    let t4;
    if ($[11] !== data || $[12] !== validateform) {
        t4 = ({
            "LoginPage[handleSubmit]": (e_0)=>{
                ...
                if (validateform()) {
                    ...
                    }["LoginPage[handleSubmit > setTimeout()]"], 1500);
                }
            }
    ...
    const loginoregister = t5;
    const t6 = login ? "Login" : "Register";
    let t7;
    if ($[16] !== t6) {
    ...
    const t12 = data.password;
    let t13;
    if ($[27] !== handleChange) {
        t13 = handleChange("password");
        $[27] = handleChange;
        $[28] = t13;
    } else {
        t13 = $[28];
    ...
    const t15 = loading ? "Loading..." : login ? "Login" : "Register";
    let t16;
    if ($[32] !== t15) {
    ...
    let t17;
    if ($[34] !== handleSubmit || $[35] !== t11 || $[36] !== t14 || $[37] !== t16 || $[38] !== t8) {
    ...
    const t18 = login ? "Don't have an account?" : "Already have an account?";
    const t19 = login ? "Register" : "Login";
    let t20;
    if ($[40] !== loginoregister || $[41] !== t19) {
...
_s(LoginPage, "K7ppfOnHpQc6Cj1cV4jGAsYNai0=");
_c = LoginPage;
;
var _c;
...
//# sourceMappingURL=_83041d29._.js.map