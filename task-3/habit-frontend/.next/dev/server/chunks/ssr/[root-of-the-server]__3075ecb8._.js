...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            setLoading(true);
            if (login) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].login(data.email, data.password);
            } else {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].register(data.email, data.password, data.name);
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3075ecb8._.js.map